...
HD_PWD='C:/Users/Gil/Desktop/Lab8_singlecycle/Lab8_singlecycle/Lab8_singlecycle.runs/impl_2'
cd "$HD_PWD"
...
EAStep vivado -log fpga_Single_Cycle_SoC.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fpga_Single_Cycle_SoC.tcl -notrace
