...
HD_PWD='C:/Users/Gil/Desktop/Lab8_singlecycle/Lab8_singlecycle/Lab8_singlecycle.runs/synth_2'
cd "$HD_PWD"
...
EAStep vivado -log fpga_Single_Cycle_SoC.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fpga_Single_Cycle_SoC.tcl
